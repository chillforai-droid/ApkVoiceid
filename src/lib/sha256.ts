...
// SHA-256 over the actual file bytes. expo-crypto.digestStringAsync hashes the
// characters of a string, so hashing FileSystem's base64 text directly does
// NOT match the web client's crypto.subtle.digest(file.arrayBuffer()).
